...
sns.catplot(x='original_language', kind='count', data=movies_other_language, palette='GnBu_d',
aspect=2, order=movies_other_language.original_language.value_counts().index)
plt.show()